...
COMPETITOR_SEARCH_MAX_RESULTS = max(
    1, int(os.getenv("COMPETITOR_SEARCH_MAX_RESULTS", "30"))
)
COMPETITOR_SEARCH_PER_DOMAIN_MAX = max(
    1, int(os.getenv("COMPETITOR_SEARCH_PER_DOMAIN_MAX", "2"))
)
...
RAG_EMBED_BATCH_SIZE = max(1, int(os.getenv("RAG_EMBED_BATCH_SIZE", "64")))
